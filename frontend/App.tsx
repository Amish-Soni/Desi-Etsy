...
import { Product, Artisan, Category, CartItem } from './types';
...
// Icon Imports needed for App.tsx itself
...
const App: React.FC = () => {
  ...
  const handleRatingChange = (rating: number) => setSelectedRating(prev => (prev === rating ? null : rating));
  ...
  return (
    <div id="home" className="min-h-screen bg-gray-50">
      <Header
        ...
        // Pass the modal trigger functions to the Header
